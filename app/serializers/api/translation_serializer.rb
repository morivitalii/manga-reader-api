...
class Api::TranslationSerializer < Api::ApplicationSerializer
  serialize_objects :translation_available_content_languages, with: Api::ContentLanguageSerializer
  serialize_objects :translation_completed_content_languages, with: Api::ContentLanguageSerializer
  serialize_objects :translation_content_languages_in_progress, with: Api::ContentLanguageSerializer
  serialize_objects :translation_absent_content_languages, with: Api::ContentLanguageSerializer
