class Api::UpdateBook
	include ActiveModel::Model

	attr_accessor :book, :title, :description, :publication_status, :original_content_language_id,
	...
	def destroy_artists(type, artist_ids)
		book.resource_artists.each do |resource_artist|
	...
	def artist_attached?(type, artist_id)
		book.resource_artists.any? do |resource_artist|
	...
	def destroy_tags(type, tag_ids)
		book.resource_tags.each do |resource_tag|
	...
	def tag_attached?(type, tag_id)
		book.resource_tags.any? do |resource_tag|
