...
RSpec.describe GenresController do
  describe ".index" do
    it "returns valid response" do
      ...
      expect(response).to match_json_schema("controllers/genres_controller/index/200")
  ...
  describe ".show" do
    it "returns valid response" do
      ...
      get "/genres/#{genre.to_param}.json"

      expect(response).to have_http_status(200)
      expect(response).to match_json_schema("controllers/genres_controller/show/200")
    end
  end
end
