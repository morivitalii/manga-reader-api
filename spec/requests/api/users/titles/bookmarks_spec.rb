...
RSpec.describe Api::Users::Titles::BookmarksController do
  describe ".index", context: :as_signed_in_user do
    it "returns valid response" do
      ...
      get "/api/users/titles/bookmarks.json", params: params

      expect(response).to have_http_status(200)
      expect(response).to match_json_schema("controllers/api/users/titles/bookmarks_controller/index/200")
