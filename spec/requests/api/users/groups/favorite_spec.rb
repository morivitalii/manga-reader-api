...
RSpec.describe Api::Users::Groups::FavoritesController do
  describe ".index", context: :as_signed_in_user do
    it "returns valid response" do
      ...
      get "/api/users/groups/favorites.json", params: params

      expect(response).to have_http_status(200)
      expect(response).to match_json_schema("controllers/api/users/groups/favorites_controller/index/200")
